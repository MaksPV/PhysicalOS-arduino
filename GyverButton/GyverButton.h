...
/*
	...
	Версия 3.2.1 (модификация Максима Попова)
	- Четвертное нажатие isQuadruple()
	- Пятерное нажатие isQuintuple()
...
class GButton {
  public:
	...
	boolean isQuadruple();	// возвращает true при четвертном клике. Сбрасывается после вызова
	boolean isQuintuple();	// возвращает true при пятерном клике. Сбрасывается после вызова
